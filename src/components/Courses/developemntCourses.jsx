        ...
        <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
          ...
          >
            <a
              ...
              data-height="140"
            >
              <img src="images/paths/angular_430x168.png" alt="course" />
        ...
        <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
          ...
          >
            <a
              ...
              data-height="140"
            >
              <img src="images/paths/swift_430x168.png" alt="course" />
              <span class="overlay__content">
                <span class="overlay__action d-flex flex-column text-center">
                  <i class="material-icons icon-32pt">play_circle_outline</i>
                  <span class="card-title text-white">Preview</span>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
          ...
          >
            <a
              ...
              data-height="140"
            >
              <img src="images/paths/wordpress_430x168.png" alt="course" />
              <span class="overlay__content">
                <span class="overlay__action d-flex flex-column text-center">
                  <i class="material-icons icon-32pt">play_circle_outline</i>
                  <span class="card-title text-white">Preview</span>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
          ...
          >
            <a
              ...
              data-height="140"
            >
              <img src="images/paths/react_430x168.png" alt="course" />
              <span class="overlay__content">
                <span class="overlay__action d-flex flex-column text-center">
                  <i class="material-icons icon-32pt">play_circle_outline</i>
                  <span class="card-title text-white">Preview</span>
